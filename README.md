...
| 디스크 | 크기 (바이트) | SHA-256 |
|---|---:|---|
| Disc 1 | 703,078,656 | `ea1a90a7c934ef467b1af684b3eeb7d36212f0aed5cfd57fd1c32bf1cfa3fc1a` |
| Disc 2 | 610,675,632 | `e977d957234c9f2c1f080608e646200a2f5de879b8e31bd1a50932a68c3aa39d` |
...
### 강조 글자·표시 정리 (같은 날 추가분)

- **강조(큰 글자)로 표시된 대사와 뒤따르는 서술이 한 줄에 붙어 있던 곳**을
  줄로 나눠 읽기 쉽게 했습니다.
- 원작은 보통 크기로 그리는데 **한국어판에서만 커져 있던 낱말 26곳**을
  본래 크기로 되돌렸습니다. 줄이 넘치던 화면도 함께 풀렸습니다.
- 원작보다 **강조 범위가 넓게 잡혀 있던 구간**을 원작과 같은 범위로 좁혔습니다.
- 용어 해설 한 항목을 **원작처럼 한자를 크게 보여주는 형태로** 복원했습니다.
- 촬영 현장 은어가 오가는 대목의 **말장난을 한국어에서도 통하도록** 다시
  짰습니다. 일본어를 알아야만 웃을 수 있던 부분입니다.
- **눌러도 아무 변화가 없던 헛 입력 대기 344곳**을 없애고, 대기 위치를
  원문 기준으로 맞췄습니다.
- 일괄 작업이 되돌려 놓았던 **일부 페이지의 줄 배치를 복구**했습니다.
